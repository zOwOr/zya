        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un Dashboard de clientes le permite recopilar y visualizar fácilmente los datos de los clientes a partir de la optimización de <br>
                        la experiencia del cliente, garantizando su retención. </p>
                </div>
                <div>
                    <a href="{{ route('customers.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Nuevo Cliente</a>
                    <a href="{{ route('customers.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Limpiar Busqueda</a>
                </div>
            </div>
        </div>
