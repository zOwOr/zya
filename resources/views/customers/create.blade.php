                                        ...
                                        <div class="profile-img-edit">
                                            <div class="crm-profile-img-edit">
                                                <img class="crm-profile-pic rounded-circle avatar-100 image-preview"
                                                    id="image-preview" src="{{ asset('assets/images/user/1.png') }}"
                                                    alt="profile-pic">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class=" row align-items-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tit_name') is-invalid @enderror"
                                        id="tit_name" name="tit_name" value="{{ old('tit_name') }}" required>
                                    @error('tit_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tit_facebook') is-invalid @enderror"
                                        id="tit_facebook" name="tit_facebook" value="{{ old('tit_facebook') }}" required>
                                    @error('tit_facebook')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tit_email') is-invalid @enderror"
                                        id="tit_email" name="tit_email" value="{{ old('tit_email') }}" required>
                                    @error('tit_email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control @error('tit_status') is-invalid @enderror" id="tit_status"
                                        ...
                                        <option value="aprobado" {{ old('tit_status') == 'aprobado' ? 'selected' : '' }}>
                                            Aprobado</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tit_work') is-invalid @enderror"
                                        id="tit_work" name="tit_work" value="{{ old('tit_work') }}">
                                    @error('tit_work')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('tit_city') is-invalid @enderror"
                                        id="tit_city" name="tit_city" value="{{ old('tit_city') }}" required>
                                    @error('tit_city')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class=" row align-items-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('ref1_name') is-invalid @enderror"
                                        id="ref1_name" name="ref1_name" value="{{ old('ref1_name') }}" required>
                                    @error('ref1_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('ref1_phone') is-invalid @enderror"
                                        id="ref1_phone" name="ref1_phone" value="{{ old('ref1_phone') }}" required>
                                    @error('ref1_phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class=" row align-items-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('ref2_name') is-invalid @enderror"
                                        id="ref2_name" name="ref2_name" value="{{ old('ref2_name') }}" required>
                                    @error('ref2_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('ref2_phone') is-invalid @enderror"
                                        id="ref2_phone" name="ref2_phone" value="{{ old('ref2_phone') }}" required>
                                    @error('ref2_phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class=" row align-items-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('ref3_name') is-invalid @enderror"
                                        id="ref3_name" name="ref3_name" value="{{ old('ref3_name') }}" required>
                                    @error('ref3_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('ref3_phone') is-invalid @enderror"
                                        id="ref3_phone" name="ref3_phone" value="{{ old('ref3_phone') }}" required>
                                    @error('ref3_phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class=" row align-items-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('aval_name') is-invalid @enderror"
                                        id="aval_name" name="aval_name" value="{{ old('aval_name') }}" required>
                                    @error('aval_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('aval_phone') is-invalid @enderror"
                                        id="aval_phone" name="aval_phone" value="{{ old('aval_phone') }}" required>
                                    @error('aval_phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
