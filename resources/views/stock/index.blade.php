    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Lista de productos en stock</h4>
                    <p class="mb-0">Un Dashboard de productos de stock le permite recopilar y visualizar fácilmente datos de productos de stock a partir de la optimización de <br>
        ...
        <div class="col-lg-12">
            <div class="table-responsive rounded mb-3">
                <table class="table mb-0 datatable-export" data-can-export="{{ auth()->user()?->can('stock.export') ? 'true' : 'false' }}">
