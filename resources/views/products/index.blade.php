            ...
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">Un Dashboard de productos le permite recopilar y visualizar fácilmente los datos
                            de los productos a partir de la optimización de <br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('products.destroy', $product->id) }}" method="POST"
                                            style="margin-bottom: 5px" id="deleteForm-{{ $product->id }}">
                                            @method('delete')
                                            @csrf
