        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="table-responsive rounded mb-3">
                    <table class="table mb-0 datatable-export" data-can-export="{{ auth()->user()?->can('user.export') ? 'true' : 'false' }}">
                        ...
                        <tbody class="ligth-body">
                            @forelse ($users as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->email }}</td>
                                    <td>
                                        {{ $item->last_login_at ? $item->last_login_at->format('d/m/Y H:i') : 'Nunca' }}
                                    </td>
