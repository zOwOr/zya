    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un Dashboard de proveedores le permite recopilar y visualizar fácilmente los datos de los proveedores a partir de la optimización de <br>
                        la experiencia del proveedor, garantizando su retención. </p>
                </div>
                <div>
                    <a href="{{ route('suppliers.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Nuevo Proveedor</a>
                    <a href="{{ route('suppliers.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Limpiar Busqueda</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="table-responsive rounded mb-3">
                <table class="table mb-0 datatable-export" data-can-export="{{ auth()->user()?->can('supplier.export') ? 'true' : 'false' }}">
