            ...
            <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1 font-weight-bold">
                        <i class="fa-solid fa-plus-circle text-primary mr-2"></i>Nueva Sucursal
                    </h4>
                    <p class="text-muted mb-0 font-size-13">
                        Registra una nueva sucursal y su información de contacto que se reflejará en las notas de venta en PDF.
                    </p>
                </div>
                <div>
                    ...
                    <form action="{{ route('branches.store') }}" method="POST">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('name') }}"
                                           placeholder="Ej: Allende o Montemorelos"
                                           required>
                                </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="address"
                                      ...
                                      placeholder="Ejemplo:
Lerdo de Tejada #306, Local C
entre Hidalgo y Morelos">{{ old('address') }}</textarea>
                        ...
                        <div class="card bg-light border mb-4">
                            ...
                            <div class="card-body py-3">
                                <div class="p-3 bg-white border rounded" style="font-family: Arial, sans-serif; font-size: 11px; max-width: 320px;">
                                    <strong id="preview-name" class="font-size-12">{{ old('name') ?: 'Nombre Sucursal' }}</strong><br>
                                    <span id="preview-address" style="white-space: pre-line; color: #333;">{{ old('address') ?: 'Calle y número, entrecalles, colonia' }}</span><br>
                                    <span id="preview-phone" style="color: #333;">{{ old('phone') ? 'Tel. '.old('phone') : 'Tel. 000 000 0000' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fa-solid fa-save mr-1"></i>Crear Sucursal
                            </button>
                        </div>
                    </form>
                </div>
