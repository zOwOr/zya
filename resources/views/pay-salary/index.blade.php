    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Lista de salarios</h4>
                    <p class="mb-0">Un Dashboard de salario de pago le permite recopilar y visualizar fácilmente los datos de salario de pago de optimizar <br>
                        la experiencia del salario de pago, garantizando la retención del salario de pago. </p>
                </div>
                <div>
        ...
        <div class="col-lg-12">
            <div class="table-responsive rounded mb-3">
                <table class="table mb-0 datatable-export" data-can-export="{{ auth()->user()?->can('salary.export') ? 'true' : 'false' }}">
                    <thead class="bg-white text-uppercase">
                        <tr class="ligth ligth-data">
                            ...
                            <th>@sortablelink('advance_salary', 'Anticipo de salario')</th>
                            <th>Total a Pagar</th>
                            <th>Acción</th>
                        </tr>
                    </thead>
