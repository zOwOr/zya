...
<html lang="zxx">
<head>
    <title>Zya - Punto de Venta</title>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                                    <div class="invoice-number">
                                        <h4 class="inv-title-1">Fecha de Nota de Venta:</h4>
                                        <p class="invo-addr-1">
                                            {{ $order->order_date }}
                                        </p>
                                    </div>
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    ...
                                    <p class="inv-from-2">ZYA CELULARES, ACCESORIOS Y REPARACIONES</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    ...
                                    <p class="inv-from-1">Estatus de Pago: {{ $order->payment_status }}</p>
                                    <p class="inv-from-1">Total Pagado: ${{ $order->pay }}</p>
                                    <p class="inv-from-1">Debido: ${{ $order->due }}</p>
                                </div>
                            </div>
                        </div>
