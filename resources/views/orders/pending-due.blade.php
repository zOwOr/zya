        ...
        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" id="search" class="form-control" name="search"
                                        placeholder="Buscar orden" value="{{ request('search') }}">
            ...
            <div class="col-lg-12">
                <div class="table-responsive rounded mb-3">
                    <table class="table mb-0 datatable-export" data-can-export="{{ auth()->user()?->can('orders.export') ? 'true' : 'false' }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center list-action">
                                            ...
                                            <button type="button" class="btn btn-primary-dark mr-2" data-toggle="modal"
                                                ...
                                                onclick="payDue(this.id)">Abonar Pago</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="payment_method" id="payment_method" class="form-control">
                                    ...
                                    <option value="Due">Crédito</option>
                                </select>
                            </div>
                        </div>
                    </div>
