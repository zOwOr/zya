    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Ordenes Pendientes de Pago</h4>
                </div>
                <div>
                    <a href="{{ route('order.pendingDue') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Limpiar Busqueda</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control" name="search" placeholder="Buscar orden" value="{{ request('search') }}">
                ...
                <table class="table mb-0">
                    <thead class="bg-white text-uppercase">
                        <tr class="ligth ligth-data">
                            ...
                            <th>@sortablelink('Pagado')</th>
                            <th>@sortablelink('Debido')</th>
                            <th>Accion</th>
                        </tr>
                    </thead>
        ...
        <div class="modal-content">
            <form action="{{ route('order.updateDue') }}" method="post">
                ...
                <div class="modal-body">
                    <h3 class="modal-title text-center mx-auto">Abonar Pago</h3>
                    <div class="col-md-12">
