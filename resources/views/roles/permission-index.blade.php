        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un Dashboard de permisos le permite recopilar y visualizar fácilmente los datos de permisos de optimizar <br>
                        la experiencia de permisos, garantizando la retención de permisos. </p>
                </div>
                <div>
                    <a href="{{ route('permission.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Nuevo Permiso</a>
                </div>
            </div>
        </div>
