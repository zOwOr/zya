...
public function show(Repairs $repair)
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'foto_recibido_frontal' => 'nullable|file|mimes:jpeg,png,jpg,gif,pdf,webp|max:2048',
            'foto_recibido_trasera' => 'nullable|file|mimes:jpeg,png,jpg,gif,pdf,webp|max:2048',
            'foto_entregado_frontal' => 'nullable|file|mimes:jpeg,png,jpg,gif,pdf,webp|max:2048',
            'foto_entregado_trasera' => 'nullable|file|mimes:jpeg,png,jpg,gif,pdf,webp|max:2048',
